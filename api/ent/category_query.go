...
func (cq *CategoryQuery) loadMovies(ctx context.Context, query *MovieQuery, nodes []*Category, init func(*Category), assign func(*Category, *Movie)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(category.MoviesTable)
		s.Join(joinT).On(s.C(movie.FieldID), joinT.C(category.MoviesPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(category.MoviesPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(category.MoviesPrimaryKey[0]))
