...
func (cu *CategoryUpdate) AddMovieIDs(ids ...int) *CategoryUpdate {
	cu.mutation.AddMovieIDs(ids...)
	return cu
}

// AddMovies adds the "movies" edges to the Movie entity.
func (cu *CategoryUpdate) AddMovies(m ...*Movie) *CategoryUpdate {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
...
func (cu *CategoryUpdate) ClearMovies() *CategoryUpdate {
	cu.mutation.ClearMovies()
	return cu
}

// RemoveMovieIDs removes the "movies" edge to Movie entities by IDs.
func (cu *CategoryUpdate) RemoveMovieIDs(ids ...int) *CategoryUpdate {
	cu.mutation.RemoveMovieIDs(ids...)
	return cu
}

// RemoveMovies removes "movies" edges to Movie entities.
func (cu *CategoryUpdate) RemoveMovies(m ...*Movie) *CategoryUpdate {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
...
// AddMovieIDs adds the "movies" edge to the Movie entity by IDs.
func (cuo *CategoryUpdateOne) AddMovieIDs(ids ...int) *CategoryUpdateOne {
	cuo.mutation.AddMovieIDs(ids...)
	return cuo
}

// AddMovies adds the "movies" edges to the Movie entity.
func (cuo *CategoryUpdateOne) AddMovies(m ...*Movie) *CategoryUpdateOne {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
...
// ClearMovies clears all "movies" edges to the Movie entity.
func (cuo *CategoryUpdateOne) ClearMovies() *CategoryUpdateOne {
	cuo.mutation.ClearMovies()
	return cuo
}

// RemoveMovieIDs removes the "movies" edge to Movie entities by IDs.
func (cuo *CategoryUpdateOne) RemoveMovieIDs(ids ...int) *CategoryUpdateOne {
	cuo.mutation.RemoveMovieIDs(ids...)
	return cuo
}

// RemoveMovies removes "movies" edges to Movie entities.
func (cuo *CategoryUpdateOne) RemoveMovies(m ...*Movie) *CategoryUpdateOne {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
