...
func (lu *LanguageUpdate) AddQuoteIDs(ids ...int) *LanguageUpdate {
	lu.mutation.AddQuoteIDs(ids...)
	return lu
}

// AddQuotes adds the "quotes" edges to the MovieQuote entity.
func (lu *LanguageUpdate) AddQuotes(m ...*MovieQuote) *LanguageUpdate {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return lu.AddQuoteIDs(ids...)
}
...
func (lu *LanguageUpdate) ClearQuotes() *LanguageUpdate {
	lu.mutation.ClearQuotes()
	return lu
}

// RemoveQuoteIDs removes the "quotes" edge to MovieQuote entities by IDs.
func (lu *LanguageUpdate) RemoveQuoteIDs(ids ...int) *LanguageUpdate {
	lu.mutation.RemoveQuoteIDs(ids...)
	return lu
}

// RemoveQuotes removes "quotes" edges to MovieQuote entities.
func (lu *LanguageUpdate) RemoveQuotes(m ...*MovieQuote) *LanguageUpdate {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return lu.RemoveQuoteIDs(ids...)
}
...
func (lu *LanguageUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if lu.mutation.QuotesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   language.QuotesTable,
			Columns: []string{language.QuotesColumn},
			Bidi:    false,
	...
	if nodes := lu.mutation.RemovedQuotesIDs(); len(nodes) > 0 && !lu.mutation.QuotesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   language.QuotesTable,
	...
	if nodes := lu.mutation.QuotesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   language.QuotesTable,
...
// AddQuoteIDs adds the "quotes" edge to the MovieQuote entity by IDs.
func (luo *LanguageUpdateOne) AddQuoteIDs(ids ...int) *LanguageUpdateOne {
	luo.mutation.AddQuoteIDs(ids...)
	return luo
}

// AddQuotes adds the "quotes" edges to the MovieQuote entity.
func (luo *LanguageUpdateOne) AddQuotes(m ...*MovieQuote) *LanguageUpdateOne {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return luo.AddQuoteIDs(ids...)
}
...
// ClearQuotes clears all "quotes" edges to the MovieQuote entity.
func (luo *LanguageUpdateOne) ClearQuotes() *LanguageUpdateOne {
	luo.mutation.ClearQuotes()
	return luo
}

// RemoveQuoteIDs removes the "quotes" edge to MovieQuote entities by IDs.
func (luo *LanguageUpdateOne) RemoveQuoteIDs(ids ...int) *LanguageUpdateOne {
	luo.mutation.RemoveQuoteIDs(ids...)
	return luo
}

// RemoveQuotes removes "quotes" edges to MovieQuote entities.
func (luo *LanguageUpdateOne) RemoveQuotes(m ...*MovieQuote) *LanguageUpdateOne {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return luo.RemoveQuoteIDs(ids...)
}
...
func (luo *LanguageUpdateOne) sqlSave(ctx context.Context) (_node *Language, err error) {
	...
	if nodes := luo.mutation.RemovedQuotesIDs(); len(nodes) > 0 && !luo.mutation.QuotesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   language.QuotesTable,
	...
	if nodes := luo.mutation.QuotesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   language.QuotesTable,
