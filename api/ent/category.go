...
func (e CategoryEdges) MoviesOrErr() ([]*Movie, error) {
	if e.loadedTypes[0] {
		return e.Movies, nil
	}
...
// QueryMovies queries the "movies" edge of the Category entity.
func (c *Category) QueryMovies() *MovieQuery {
	return NewCategoryClient(c.config).QueryMovies(c)
}
